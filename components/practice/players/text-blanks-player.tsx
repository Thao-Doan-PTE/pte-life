...
import { TextBlanksInput } from "@/components/practice/text-blanks-input";
...
export function TextBlanksPlayer({
  questionId,
  audioUrl,
  segments,
}: {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {hasPlayed && (
        <>
          <TextBlanksInput segments={segments} onAnswersChange={setAnswers} />
          <Button
